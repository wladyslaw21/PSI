...
text <- readLines("Trump - State of the Union_25.02.2026.txt", encoding="UTF-8")



# Podzia³ tekstu na równe segmenty o ustalonej d³ugoœci ----
...
if(nrow(df_all) == 0) {
  stop("B³¹d: Po usuniêciu brakuj¹cych danych nie zosta³y ¿adne obserwacje do analizy!")
}
